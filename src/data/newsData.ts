  ...
  return (
    <div className="max-w-7xl mx-auto py-8">
      <div className="flex justify-between items-center mb-8 mx-5">
        <h2 className="text-2xl font-inter font-semibold text-gray-900 border-l-4 rounded-l-sm h-16 border-primary">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mx-5">  {/* Mengatur grid menjadi 4 kolom */}
        {currentItems.map((news: NewsItem) => (
          <div key={news.id} className="flex flex-col bg-white rounded-xl overflow-hidden shadow-md">
            ...
            <div className="flex flex-col justify-between p-4 flex-grow"> {/* Tambahkan flex-grow */}
              ...
              <div className="flex justify-between items-center text-xs text-grayskin mt-auto"> {/* Pastikan elemen ini tetap di bagian bawah */}
